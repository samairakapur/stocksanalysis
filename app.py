...
with tab1:
	...
	exp.image(img2)
	exp.write("Equity (in the stock market) refers to the amount of shares owned by a company. As an investor, when you buy the shares of a company, you buy an equivalent degree of ownership in that company. The stock market is where these company shares (equity) are bought and sold from one investor to another. The word ‘stock’ is synonymous with the word 'equity.")
	exp.write("2. Bull Market / Bear Market")
	...
	exp.write("3. Bid / Ask")
	exp.write("The ask price or an offer refers to the lowest amount of money that the seller of a stock is willing to accept for a share of that stock whilst a bid refers to the highest amount of money that a potential buyer for a stock is willing to pay for a share of that stock. If there are multiple buyers for a stock, a bid taken between buyers ends when one buyer places a bid that the other buyers cannot or do not wish to match.")
	exp.write("4. Exchange")
	exp.write("An exchange refers to a place or an electronic market where various securities are traded. i.e. one of the many stock exchanges in the country or worldwide where shares of stocks are bought and sold.")
	exp.write("5. Volatility") 
	exp.write("Volatility refers to the rate of price fluctuations of a share. A highly volatile stock experiences daily up and down movements in its price. Some traders profit off the risks involved in highly volatile stocks, while others prefer investing in less volatile stocks for the long run.")
	exp.write("6. Blue-Chip Stocks")
	exp.write("Stocks of large, well-established, and financially stable companies with a history of reliable performance.")
	exp.write("7. Price to Earning (P/E) ratio")
	exp.write("A valuation of companies last traded share price to its latest reported 12 months earnings per share. For example, if the last traded share price of any X company is $40 and earnings over a last 12 months per share is $20 then the P/E ratio of that X company is $20 (40/2)")
	exp.write("8. Price to Book (P/B) ratio")
	exp.write("The Price-to-Book (P/B) ratio is a financial metric used to evaluate a company's market value relative to its book value. It is calculated by dividing the market price per share by the book value per share. The P/B ratio provides insights into how the market values a company in relation to its accounting book value.")
	exp.write("9. Divident")
	exp.write("A portion of the company’s earnings decided to pay to its shareholders in return for their investments. It is usually declared as a percentage of current share price or some specified dollar value, usually decided by the board of directors of the company.")
	exp.write("10. Mid-Cap")
	exp.write("Mid-cap, short for ‘mid-capitalization,’ refers to companies with a market capitalization between that of large-cap (large capitalization) and small-cap (small capitalization) companies. Market capitalization is calculated by multiplying the current stock price by the total number of outstanding shares.")
