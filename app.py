...
with tab1:
	...
	container6.write("Many people are often setback by investing in stocks because of 2 things: either they don't know how/where to invest AND/OR they don't have the time to constantly keep a track of their stock indicies") 
	container6.write("These are 2 problems that I aim to address later in the website") 
